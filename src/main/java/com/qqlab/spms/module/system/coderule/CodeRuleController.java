...
public class CodeRuleController extends BaseController<CodeRuleEntity, CodeRuleService, CodeRuleRepository> {
    ...
    public JsonData getFieldList() {
        return jsonData(EnumUtil.getEnumMapList(CodeRuleField.class, "value", "label", "defaultPrefix"));
    }
    ...
    public JsonData getParamList() {
        return jsonData(EnumUtil.getEnumMapList(CodeRuleParam.class, "value", "label", "desc", "demo"));
    }
    ...
    public JsonData getSerialNumberUpdate() {
        return jsonData(EnumUtil.getEnumMapList(SerialNumberUpdate.class));
    }
}
